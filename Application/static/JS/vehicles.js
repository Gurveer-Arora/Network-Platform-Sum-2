...
const PAINT = {
    red: "#9B2C2C", blue: "#2C4A7C", green: "#3F5D52", yellow: "#D9A521",
    orange: "#C56A2C", purple: "#5B3A7C", mauv: "#E0B0FF", pink: "#C27B94",
    teal: "#2F6B6B", maroon: "#6B2233", violet: "#7C5AA0", indigo: "#3B3F7A",
    crimson: "#8E1F2F", turquoise: "#3FA39B", aquamarine: "#7FCFC4", fuscia: "#B3488E",
    khaki: "#A89A6B", goldenrod: "#C9A227", puce: "#8E5A66",
};
